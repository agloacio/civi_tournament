<?php
/**
 * Persist IndividualPrefixesOptionGroup Settings
 *
 * Creates and retrieves IndividualPrefixesOptionGroup setting for CiviTournament Extension
 *
 * @version 1.0
 * @author steig
 */
...
class IndividualPrefixesOptionGroup extends Settings
{
