...
class CRM_CiviTournament_Form_Phone extends CRM_CiviTournament_Form
{
  public function __construct($state, $action, $method, $name)
  {
    ...
    $this->_formElements = array(
      ...
      new FormElement($entity, 'phone_type_id', 'phone_type_id', 'Hidden', TRUE),
      new FormElement($entity, 'phone', 'Phone #', 'Text', TRUE),
      new FormElement($entity, 'phone_ext', 'Extension', 'Text', TRUE)
    );
  }
