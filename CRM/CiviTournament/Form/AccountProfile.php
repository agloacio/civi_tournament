...
/**
 * CRM_CiviTournament_Form_AccountProfile lets a new user apply for an account.
 *
 * An account profile combines contact information for an individual, an organization and a registration group. If approved, the indivdial gets full access to the organizationa and all contacts in the registration group.
 *
 * @version 1.0
 * @author msteigerwald
 */

class CRM_CiviTournament_Form_AccountProfile extends CRM_CiviTournament_Form {
  ...
  )
  {
    ...
    $this->_entityLabel = "Account Profile";
  }
  ...
  public function buildQuickForm() {
    ...
    $this->add('text', 'mobile_phone', ts('Mobile Phone'), array('placeholder' => ts('Mobile Phone'), 'title' => ts('How can we reach you at the tournament?')));
